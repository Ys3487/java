...
访问成功： ![1536488631901](../../images/jvm/1536488631901.png)
...
### 3.1、jdk1.7的堆内存模型
 ...
 ![1536501289198](../../images/jvm/1536501289198.png)
...
### 3.2、jdk1.8的堆内存模型
 ...
 ![1536501652150](../../images/jvm/1536501652150.png)
...
需要特别说明的是：Metaspace所占用的内存空间不是在虚拟机内部，而是在本地内存空间中，这也是与1.7的永久代最大的区别所在。 
 	...
 	![1536507420882](../../images/jvm/1536507420882.png)
...
~~~
  ...
  ![1536512769514](../../images/jvm/1536512769514.png)
...
![1536513416186](../../images/jvm/1536513416186.png)

在最后面有OQL查询功能。

 ![1536513474958](../../images/jvm/1536513474958.png)

 ![1536513591638](../../images/jvm/1536513591638.png)
...
官网地址：https://www.eclipse.org/mat/
 ...
 ![1536515331814](../../images/jvm/1536515331814.png)

#### 4.5.2、下载安装

下载地址：https://www.eclipse.org/mat/downloads.php

 ![1536515395914](../../images/jvm/1536515395914.png)

将下载得到的MemoryAnalyzer-1.8.0.20180604-win32.win32.x86_64.zip进行解压：

 ![1536515524838](../../images/jvm/1536515524838.png)

#### 4.5.3、使用

 ![1536515700264](../../images/jvm/1536515700264.png)

 ![1536515764096](../../images/jvm/1536515764096.png)

 ![1536515922938](../../images/jvm/1536515922938.png)

 ![1536516001249](../../images/jvm/1536516001249.png)

查看对象以及它的依赖： 

![1536516171924](../../images/jvm/1536516171924.png)

查看可能存在内存泄露的分析： ![1536516259369](../../images/jvm/1536516259369.png)
...
为了演示效果，我们将设置执行的参数，这里使用的是Idea编辑器。
 ...
 ![1536591244437](../../images/jvm/1536591244437.png)
...
可以看到，当发生内存溢出时，会dump文件到java_pid5348.hprof。 ![1536591747657](../../images/jvm/1536591747657.png)

### 5.3、导入到MAT工具中进行分析

![1536592135948](../../images/jvm/1536592135948.png)
...
![1536594010544](../../images/jvm/1536594010544.png)
...
### 6.1、线程的状态
 ...
 ![1536601656694](../../images/jvm/1536601656694.png)
...
在jdk的安装目录的bin目录下，找到jvisualvm.exe，双击打开即可。
 ...
 ![1536654243155](../../images/jvm/1536654243155.png)

 

![1536654347046](../../images/jvm/1536654347046.png)

### 7.2、查看本地进程

 ![1536654611922](../../images/jvm/1536654611922.png)

### 7.3、查看CPU、内存、类、线程运行信息

 ![1536654708421](../../images/jvm/1536654708421.png)

### 7.4、查看线程详情

![1536654784904](../../images/jvm/1536654784904.png)

也可以点击右上角Dump按钮，将线程的信息导出，其实就是执行的jstack命令。

![1536656468818](../../images/jvm/1536656468818.png)
...
![1536678677028](../../images/jvm/1536678677028.png)
...
添加远程主机：
 ...
 ![1536681377182](../../images/jvm/1536681377182.png)

在一个主机下可能会有很多的jvm需要监控，所以接下来要在该主机上添加需要监控的jvm：

 ![1536681543452](../../images/jvm/1536681543452.png)

 ![1536681575620](../../images/jvm/1536681575620.png)
